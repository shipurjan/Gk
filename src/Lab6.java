...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[6],0);
		gl2.glPushMatrix();
	...
	public void init(GLAutoDrawable drawable) {
        ...
        float black[] = { 0.0F, 0.0F, 0.0F, 1 };
        float white[] = {1.0F, 1.0F, 1.0F, 1};
        float dim[] = {0.5F, 0.5F, 0.5F, 1};
        float position[] = { 0.0F, 5.0F, 0.0F, 0 };
        gl2.glLightModelfv( GL2.GL_LIGHT_MODEL_AMBIENT, black, 0 );
        
        gl2.glLightfv(GL2.GL_LIGHT0, GL2.GL_POSITION, position, 0);
        gl2.glLightfv(GL2.GL_LIGHT0, GL2.GL_DIFFUSE, dim, 0);
        gl2.glLightfv(GL2.GL_LIGHT0, GL2.GL_SPECULAR, dim, 0);
        gl2.glLightfv(GL2.GL_LIGHT0, GL2.GL_AMBIENT, white, 0);
